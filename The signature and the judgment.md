...
date: 2026-07-21
---
Last month, Luigi from Provision told me two things in the same conversation. Civil engineering is "essentially solved"; it's why he left the field. And full automation of his product only becomes viable when an insurance provider is willing to indemnify the machine's decisions, which today nobody will do.

Those two statements have been colliding in my head ever since.

The design world is debating whether AI can learn taste; underneath it sits the harder question of whether accumulated experience can be learned from data at all. Aurélie Radom recently argued that it cannot be delegated: taste is the standard, judgment is the act of applying it, and someone has to take responsibility for what deserves to exist. For design I think she's right, because the standard there lives in people, built over years of exposure, implicit and re-litigated in every review meeting.

Engineering is the case her argument didn't consider. We delegated our taste a long time ago. Every code and standard is a century of judgment written down failure by failure, so that quality would stop depending on any single person's eye. What AI changes is the execution: agentic loops can now run that codified judgment deterministically, because the formulas themselves say good or bad.

Codes verify; they don't conceive. No standard tells you whether the braced core or the moment frame was the right scheme, whether it's buildable, whether it suits the ground you actually have. That upstream judgment, knowing what to automate and why, and what comes before the artefact, is the SME's real edge. It doesn't disappear. But the downstream, checkable half is where most of the billable hours live.
...
Related: [[Taste cannot be delegated]], [[More efficiency, more demand]], [[The collapsing distance]], [[Cognitive Surrender]].
